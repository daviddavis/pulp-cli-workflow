...
_test: | tests/cli.toml
	pytest -v tests pulp-glue-workflow/tests
...
_livetest: | tests/cli.toml
	pytest -v tests pulp-glue-workflow/tests -m "$(PYTEST_MARK)"
...
.PHONY: _unittest
_unittest:
	pytest -v tests pulp-glue-workflow/tests -m "not live"
...
_unittest_glue:
	pytest -v pulp-glue-workflow/tests -m "not live"
